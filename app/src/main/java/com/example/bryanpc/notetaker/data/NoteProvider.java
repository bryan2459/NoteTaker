package com.example.bryanpc.notetaker.data;
...
public class NoteProvider extends ContentProvider {
    ...
    static public final String PROVIDER_NAME = "com.example.provider.NoteProv";
    static public final String URL = "content://" + PROVIDER_NAME + "/notes";
    static public final Uri CONTENT_URI = Uri.parse(URL);

    // fields for the database
    static public final String ID = "id";
    static public final String DATEID = "dateid";
    static public final String NOTEDETAIL = "notedetail";
    static public final String NOTESTATUS = "notestatus";
    ...
    static final String DATABASE_NAME = "NoteReminder";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case NOTES:
                queryBuilder.setProjectionMap(NoteMap);
                break;
            case NOTES_ID:
        ...
        if(selection != null)
        { selection = NOTEDETAIL + " LIKE " + "'%"+selection+"%'"; }
        Log.d("TAG","select:"+selection);
